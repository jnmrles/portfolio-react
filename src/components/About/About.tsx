...
const ServiceCard= (props:{color:string, title:string, icon:any, subtitle:string}) =>(
 <ScrollAnimation animateIn="fadeInLeft" >
  <div className="flex flex-row justify-start items-center blue-glassmorphism p-3 m-4 cursor-pointer hover:shadow-xl ">
...
export function Services  () {
 ...
 <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
  <div className="flex mf:fex-row flex-col items-center justify-between md:p-20 py-12 px-6 ">
    <div className="flex-1 flex flex-col justify-start items-start ">
      <h2 className="text-white text-3xl sm:text-5xl py-2"> Services
