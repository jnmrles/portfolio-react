export default [
  {
    ...
    techList: ["Javascript","Jekyll","Sass"],
    description:"Front-End Engineer for Hack For LA's main Website. Hack for LA is A non-profit Civic-Tech organization that builds digital products and services with community partners and the local government to address issues in the LA region"
...

  {
    id: 6,
    title:"Amazon Clone",
    link:"https://fir-c271c.web.app/",
    gitHub: "https://github.com/jnmrles/amazon-clone",
    techList: ["Javascript", "React", "Material UI"],
    description:" Built A Clone of Amazon’s main landing page fully featured with User Authentication, Order History, Cart and Checkout features"
